...
<template>
    <div class="w-full px-[20px]">
        <div class="w-full flex lg:flex-col items-start gap-[20px]">
            <img :src="getImageFromUploads(`company/${company.img}`)" class="w-[45%] h-[85vh] lg:w-full lg:h-[auto] lg:max-h-[370px] object-cover rounded-[10px] border-[1px]">
            <div class="w-[55%] lg:w-full flex lg:flex-col-reverse items-start gap-[20px]">
                ...
                <span class="text-[1.25rem] md:text-[1.1rem]  leading-[40px] pt-[10px] pr-[30px] md:pt-[0px] md:pr-[4px] md:pl-[4px] dark:text-white">{{company.description}}</span>
                ...
                <span class="text-[1.25rem] md:text-[1.1rem]  leading-[40px] pt-[10px] pr-[30px] md:pt-[0px] md:pr-[4px] md:pl-[4px] dark:text-white">{{company.vision}}</span>
                ...
                <span class="text-[1.25rem] md:text-[1.1rem]  leading-[40px] pt-[10px] pr-[30px] md:pt-[0px] md:pr-[4px] md:pl-[4px] dark:text-white">{{company.mission}}</span>
                </div>
            </div>
        </div>
    </div>
