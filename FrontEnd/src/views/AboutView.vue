    ...
    <div class="w-full px-[20px]">
        <div class="w-full flex lg:flex-col items-start gap-[20px]">
            ...
            <div class="w-full flex lg:flex-col-reverse items-start gap-[20px]">
                ...
                <h1 class="text-[1.75rem] xl:text-[1.5rem] md:text-[1.25rem] font-medium text-main dark:text-second w-full pb-[4px] border-b-[1px] border-main-shadow dark:border-second-shadow">Slogan</h1>
                <span class="text-[1.25rem] md:text-[1.1rem] text-main leading-[40px] pt-[10px] pr-[30px] md:pt-[0px] md:pr-[4px] md:pl-[4px] dark:text-white"></span>
